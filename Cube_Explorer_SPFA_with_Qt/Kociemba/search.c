            ...
            if (n == depthPhase1 - 1 && (s = totalDepth(search, depthPhase1, maxDepth)) >= 0) {
                if (s == depthPhase1
                    ...
                    if (n1) {
                        ...
                        free((void*)search);
                        /*if (n1 <= s && n1 <= n2) return res1;
                        else */if (n1 < s) return res1;
                        return res;
                    }
                 /*   if (n1) {
                        res2 = solutionToString(search, s, -1);
                        if (s < maxDepth) return res2;
                        n2 = s;
                    }
                    else {*/
                        res1 = solutionToString(search, s, -1);
                        return res1;
                        if (s < maxDepth) return res1;
                        n1 = s;
                    //}
                }
            }
